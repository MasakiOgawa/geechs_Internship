...
//			particle.transform.position = new Vector3(Mathf.Lerp(m_StartPos.x, m_FinishPos.x, m_Frame), Mathf.Lerp(m_StartPos.y, m_FinishPos.y, m_Frame), Mathf.Lerp(m_StartPos.z, m_FinishPos.z, m_Frame));
